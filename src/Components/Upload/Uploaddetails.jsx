...
export default class Uploaddetails extends Component {
  constructor(props) {
    super(props);
    function createData(media_title, media_type, upload_on,status) {
      return { media_title, media_type, upload_on,status };
    }
    ...
    this.state = {
      ...
      viewmodal: false,
      doctordetails: [
        createData("Offer 10%", "Image", "28 Dec 2019 10.00","Active"),
        createData("Offer 15%", "Image", "22 Aug 2019 10.00","Inactive"),
        createData("Offer 20%", "Video", "19 Jun 2019 10.00","Active"),
        createData("Offer 40%", "Image", "12 Aug 2019 10.00","Inactive"),
        createData("Offer 20%", "Video", "02 Aug 2019 10.00","Active"),
        createData("Offer 30%", "Video", "12 Aug 2019 10.00","Inactive"),
        createData("Offer 25%", "Image", "20 Mar 2019 10.00","Active")
      ],
      viewdata: null
    };
  }
  ...
  render() {
    ...
    return (
      <div className="dashboVendorDetailsDiv">
